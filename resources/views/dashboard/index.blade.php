                        ...
                        <div class="card-header border-bottom">
                            ...
                            <ul class="nav nav-tabs card-header-tabs" id="dashboardNav">
                                <li class="nav-item me-1"><a class="nav-link active" id="overview-pill" href="#overview"
                                        data-bs-toggle="tab" aria-controls="overview" aria-selected="true">Overview</a></li>
                                <li class="nav-item"><a class="nav-link" id="activities-pill" href="#activities"
                                        data-bs-toggle="tab" aria-controls="activities" aria-selected="false">Activities</a>
                                </li>
                            </ul>
                        </div>
                        <div class="card-body">
                            <div class="tab-content" id="dashboardNavContent">
                                ...
                                <div class="tab-pane fade show active" id="overview" aria-labelledby="overview-pill">
                                    <div class="chart-area mb-lg-0 mb-4" style="height: 20rem"><canvas id="myAreaChart"
                                            width="100%" height="30"></canvas></div>
                                </div>
                                <!-- Dashboard Tab Pane 2-->
                                <div class="tab-pane fade" id="activities" aria-labelledby="activities-pill">
                            ...
                            <div class="d-flex flex-column justify-content-center">
                                ...
                                <div class="px-lg-5 px-0 text-center">
                                    ...
                                    <p class="mb-4">Our new report generation system is now online. You can
                                        start
                                        creating custom reporting for any documents available on your account.
                                    </p>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="list-group list-group-flush">
                                        <div
                                            ...
                                            <div class="me-3">
                                                <i class="fas fa-circle fa-fw fa-sm me-1 text-blue"></i>
                                                Direct
                                            </div>
                                        ...
                                        <div
                                            class="list-group-item d-flex align-items-center justify-content-between small px-0 py-2">
                                            <div class="me-3">
                                                <i class="fas fa-circle fa-fw fa-sm me-1 text-purple"></i>
                                                Social
                                            </div>
                                        ...
                                        <div
                                            class="list-group-item d-flex align-items-center justify-content-between small px-0 py-2">
                                            <div class="me-3">
                                                <i class="fas fa-circle fa-fw fa-sm me-1 text-green"></i>
                                                Referral
                                            </div>
                            ...
                            <div class="card card-header-actions mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="progress mb-3">
                                        <div class="progress-bar bg-danger" style="width: 25%" aria-valuenow="25"
                                    ...
                                    <div class="progress mb-3">
                                        <div class="progress-bar bg-warning" style="width: 50%" aria-valuenow="50"
                                            aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                    <!-- Progress item 3-->
                                    <div class="d-flex align-items-center justify-content-between small mb-1">
                                    ...
                                    <div class="progress mb-3">
                                        <div class="progress-bar bg-primary" style="width: 75%" aria-valuenow="75"
                                            aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                    <!-- Progress item 4-->
                                    <div class="d-flex align-items-center justify-content-between small mb-1">
